...
public class WARCTagCounter extends Configured implements Tool {
	...
	public int run(String[] arg0) throws Exception {
		...
		String inputPath = "./CC-MAIN-20151001215752-00000-ip-10-137-6-227.ec2.internal.warc.gz";//"data/*.warc.gz";
		//String inputPath = "common-crawl/crawl-data/CC-MAIN-2013-48/segments/1386163035819/wet/CC-MAIN-20131204131715-00000-ip-10-33-133-15.ec2.internal.warc.wet.gz";
